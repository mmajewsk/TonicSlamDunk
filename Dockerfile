...
RUN wget -O boost_1_55_0.tar.gz https://sourceforge.net/projects/boost/files/boost/1.55.0/boost_1_55_0.tar.gz/download &&\
	...
	cd boost_1_55_0/ &&\
	./bootstrap.sh --prefix=$MAINDIR/boost/ --with-libraries=program_options --with-python=$(which python3)&&\
	./b2 install &&\
	cd .. &&\
	rm -rf boost_1_55_0
